...
class SendForAll extends StatefulWidget {
  const SendForAll({
    Key? key,
  ...
  @override
  State<SendForAll> createState() => _SendForAllState();
}

class _SendForAllState extends State<SendForAll> with WidgetsBindingObserver {
                ...
                : BubbleMessage(
                    ...
                    child: Container(
                        ...
                        child: Column(
                          ...
                          Row(
                            children: [
                              CircleAvatar(child: Image.asset("assets/images/vue.png",height: 20),backgroundColor: Colors.white,
